 ...
 */
export const checkAssetAccess = (requiredPermission: 'view' | 'edit' | 'delete') => {
  ...
  return async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
    try {
      ...
      if (sharedAsset) {
        ...
        const rolePermissions = userRole.permissions as any;
        ...
        const hasPermission =
          (requiredPermission === 'view' && permissions.canView) ||
        ...
        (req as any).assetPermissions = permissions;
        // Proceed to next middleware/route handler
        return next();
      }
