...
import googleRouter from './routes/google.routes.js'; // Google OAuth and Gmail API routes
import userRouter from './routes/user.routes.js'; // User management routes
import emailProcessingRouter from './routes/email-processing.routes.js'; // Email parsing and processing routes
import smsRouter from './routes/sms.route.js'; // SMS sending and management routes
import vaultRoutes from './routes/vault.routes.js'; // Secure vault for storing assets routes
import familyRoutes from './routes/family.routes.js'; // Family member management routes
import assetSharingRouter from './routes/asset-sharing.routes.js'; // Asset sharing between users routes
import deviceInfoRouter from './routes/get-device-info.route.js'; // Device information retrieval routes
import { ServerAuthService } from './services/server-auth.service.js';
// ============================================
