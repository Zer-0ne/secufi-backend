...
export class AIService {
    ...
    async callBedrock(prompt, systemPrompt) {
        try {
...
`;
     ...
     */
    async validateExtractedData(extracted, requiredFields, // Added parameter
    attachmentContents) {
        const issues = [];
        // =====================================
...
Begin analysis now:`;
    ...
    structureData = async (data) => {
        try {
            ...
            console.log('Error in structuring the data :: ', error.message);
            return;
        }
    };
     ...
     */
    guessPassword = async (subject, body, userId, additionalDetails) => {
        try {
