...
export class JWTService {
     ...
     */
    static get ACCESS_TOKEN_EXPIRY() {
     ...
     */
    static get REFRESH_TOKEN_EXPIRY() {
    ...
    static signAccessToken(payload, expiresIn) {
        try {
            ...
            const options = {
                expiresIn: (expiresIn || this.ACCESS_TOKEN_EXPIRY), // Use custom or default expiry
    ...
    static signRefreshToken(payload, expiresIn) {
        try {
            ...
            const options = {
                expiresIn: (expiresIn || this.REFRESH_TOKEN_EXPIRY), // Use custom or default expiry
    ...
    static verifyAccessToken(token) {
        try {
            ...
            const decoded = jwt.verify(token, this.ACCESS_TOKEN_SECRET, options);
    ...
    static verifyRefreshToken(token) {
        try {
            ...
            const decoded = jwt.verify(token, this.REFRESH_TOKEN_SECRET, options);
     ...
     */
    static getPayload(token, isRefreshToken = false) {
