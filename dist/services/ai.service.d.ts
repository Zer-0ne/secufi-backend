...
export declare class AIService {
   ...
   */
    ...
    structureData: (data: string) => Promise<string | undefined>;
    private formatAdditionalDetails;
    /**
     * Guess password from email instructions and user details
     */
    guessPassword: (subject: string, body: string, userId: string, additionalDetails?: object) => Promise<string | false>;
    /**
